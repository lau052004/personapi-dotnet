    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Estudio>(entity =>
        {
            ...
            entity.HasOne(d => d.IdProfNavigation).WithMany(p => p.Estudios)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_estudio_prof");
        });

        modelBuilder.Entity<Persona>(entity =>
        {
            entity.HasKey(e => e.Cc).HasName("PK__persona__3213666DEEFA83BB");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__profesio__3213E83FEE6FB1E3");
        ...
        {
            entity.HasKey(e => e.Num).HasName("PK__telefono__DF908D6539696113");
